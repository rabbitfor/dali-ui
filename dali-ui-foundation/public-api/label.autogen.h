...
*/
Label& SetScaleX(float scaleX) { View::SetScaleX(scaleX); return *this; }
/**
* @brief Sets the y scale factor applied to the view.
*
* @param[in] scaleY The Y scale factor to set
*/
Label& SetScaleY(float scaleY) { View::SetScaleY(scaleY); return *this; }
/**
* @brief Sets the y scale factor applied to the view.
*
* @param[in] scaleX The X scale factor to set
* @param[in] scaleY The Y scale factor to set
*/
Label& SetScale(float scaleX, float scaleY) { View::SetScale(scaleX, scaleY); return *this; }
/**
...
*/
Label& SetVisibility(bool visibility) { View::SetVisibility(visibility); return *this; }
/**
...
* @return Reference to this View for fluent chaining
*/
Label& SetOpacity(float opacity) { View::SetOpacity(opacity); return *this; }
/**
* @brief Sets the X position of the View.
*
* @param[in] x The X position to set
*/
Label& SetPositionX(float x) { View::SetPositionX(x); return *this; }
/**
* @brief Sets the Y position of the View.
*
* @param[in] y The Y position to set
*/
Label& SetPositionY(float y) { View::SetPositionY(y); return *this; }
/**
* @brief Sets the parent origin of the View.
*
* @param[in] point The parent origin to set
*/
Label& SetParentOrigin(const Vector3& point) { View::SetParentOrigin(point); return *this; }
/**
* @brief Sets the pivot point of the View.
*
* @param[in] point The pivot point to set
*/
Label& SetPivotPoint(const Vector3& point) { View::SetPivotPoint(point); return *this; }
/**
...
*/
Label& SetRequestedWidth(float width) { View::SetRequestedWidth(width); return *this; }
/**
...
*/
Label& SetRequestedHeight(float height) { View::SetRequestedHeight(height); return *this; }
/**
* @brief Sets the minimum width.
*
* @param[in] width The minimum width
*/
Label& SetMinimumWidth(float width) { View::SetMinimumWidth(width); return *this; }
/**
* @brief Sets the minimum height.
*
* @param[in] height The minimum height
*/
Label& SetMinimumHeight(float height) { View::SetMinimumHeight(height); return *this; }
/**
* @brief Sets the maximum width.
*
* @param[in] width The maximum width
*/
Label& SetMaximumWidth(float width) { View::SetMaximumWidth(width); return *this; }
/**
* @brief Sets the maximum height.
*
* @param[in] height The maximum height
*/
Label& SetMaximumHeight(float height) { View::SetMaximumHeight(height); return *this; }
/**
* @brief Sets the view margin.
*
* @param[in] margin The margin to set
*/
Label& SetViewMargin(const Extents& margin) { View::SetViewMargin(margin); return *this; }
/**
* @brief Sets the view padding.
*
* @param[in] padding The padding to set
*/
Label& SetViewPadding(const Extents& padding) { View::SetViewPadding(padding); return *this; }
/**
* @brief Sets whether the actor should be focusable by keyboard navigation.
*
* @param[in] focusable True if it is focusable
*/
Label& SetFocusable(bool focusable) { View::SetFocusable(focusable); return *this; }
/**
* @brief Sets whether the actor should be focused when touched.
*
* @param[in] touchFocusable True if it gets focused when touched
*/
Label& SetTouchFocusable(bool touchFocusable) { View::SetTouchFocusable(touchFocusable); return *this; }
/**
...
*/
Label& SetBackgroundColor(const UiColor& color) { View::SetBackgroundColor(color); return *this; }
/**
...
*/
Label& SetEnabled(bool enabled) { View::SetEnabled(enabled); return *this; }
/**
* @brief Sets a uniform corner radius for all four corners.
*
* @param[in] radius The corner radius to apply to all corners
*/
Label& SetCornerRadius(float radius) { View::SetCornerRadius(radius); return *this; }
/**
...
*/
Label& SetCornerRadius(float topLeft, float topRight, float bottomRight, float bottomLeft) { View::SetCornerRadius(topLeft, topRight, bottomRight, bottomLeft); return *this; }
/**
...
*/
Label& SetCornerRadius(const Vector4& radius) { View::SetCornerRadius(radius); return *this; }
/**
...
*/
Label& SetCornerRadiusPolicy(CornerRadiusPolicy policy) { View::SetCornerRadiusPolicy(policy); return *this; }
/**
...
*/
Label& SetCornerRadiusPolicyRelative() { View::SetCornerRadiusPolicyRelative(); return *this; }
/**
...
*/
Label& SetCornerSquareness(float squareness) { View::SetCornerSquareness(squareness); return *this; }
/**
...
*/
Label& SetCornerSquareness(float topLeft, float topRight, float bottomRight, float bottomLeft) { View::SetCornerSquareness(topLeft, topRight, bottomRight, bottomLeft); return *this; }
/**
...
*/
Label& SetCornerSquareness(const Vector4& squareness) { View::SetCornerSquareness(squareness); return *this; }
/**
* @brief Sets the borderline width of the view.
*
* @param[in] width The borderline width to set
*/
Label& SetBorderlineWidth(float width) { View::SetBorderlineWidth(width); return *this; }
/**
...
* @param[in] color The UiColor to apply
*/
Label& SetBorderlineColor(const UiColor& color) { View::SetBorderlineColor(color); return *this; }
/**
* @brief Sets the borderline offset of the view.
*
* @param[in] offset The borderline offset to set
*/
Label& SetBorderlineOffset(float offset) { View::SetBorderlineOffset(offset); return *this; }
/**
* @brief Sets the name of this view.
*
* @param[in] name The name to set
*/
Label& SetName(const Dali::String& name) { View::SetName(name); return *this; }
/**
* @brief Attaches the interaction trait to this View.
*
* @return Reference to this View for fluent chaining
*/
Label& AsInteractive() { View::AsInteractive(); return *this; }
/**
...
*/
template<typename F>
Label& AsInteractive(F&& configure) { View::AsInteractive(configure); return *this; }
/**
...
* @return Reference to this View for fluent chaining
*/
Label& AsSelectable() { View::AsSelectable(); return *this; }
/**
...
*/
template<typename F>
Label& AsSelectable(F&& configure) { View::AsSelectable(configure); return *this; }
/**
...
*/
Label& As(View& self) { View::As(self); return *this; }
/**
...
* @endcode
*/
Label& SetLayoutParams(LayoutParams params) { View::SetLayoutParams(params); return *this; }
/**
...
*/
Label& Children(std::initializer_list<View> children) { View::Children(children); return *this; }
