...
*/
AnimatedImageView& SetScaleX(float scaleX) { View::SetScaleX(scaleX); return *this; }
/**
* @brief Sets the y scale factor applied to the view.
*
* @param[in] scaleY The Y scale factor to set
*/
AnimatedImageView& SetScaleY(float scaleY) { View::SetScaleY(scaleY); return *this; }
/**
* @brief Sets the y scale factor applied to the view.
*
* @param[in] scaleX The X scale factor to set
* @param[in] scaleY The Y scale factor to set
*/
AnimatedImageView& SetScale(float scaleX, float scaleY) { View::SetScale(scaleX, scaleY); return *this; }
/**
...
*/
AnimatedImageView& SetVisibility(bool visibility) { View::SetVisibility(visibility); return *this; }
/**
...
* @return Reference to this View for fluent chaining
*/
AnimatedImageView& SetOpacity(float opacity) { View::SetOpacity(opacity); return *this; }
/**
* @brief Sets the X position of the View.
*
* @param[in] x The X position to set
*/
AnimatedImageView& SetPositionX(float x) { View::SetPositionX(x); return *this; }
/**
* @brief Sets the Y position of the View.
*
* @param[in] y The Y position to set
*/
AnimatedImageView& SetPositionY(float y) { View::SetPositionY(y); return *this; }
/**
* @brief Sets the parent origin of the View.
*
* @param[in] point The parent origin to set
*/
AnimatedImageView& SetParentOrigin(const Vector3& point) { View::SetParentOrigin(point); return *this; }
/**
* @brief Sets the pivot point of the View.
*
* @param[in] point The pivot point to set
*/
AnimatedImageView& SetPivotPoint(const Vector3& point) { View::SetPivotPoint(point); return *this; }
/**
...
*/
AnimatedImageView& SetRequestedWidth(float width) { View::SetRequestedWidth(width); return *this; }
/**
...
*/
AnimatedImageView& SetRequestedHeight(float height) { View::SetRequestedHeight(height); return *this; }
/**
* @brief Sets the minimum width.
*
* @param[in] width The minimum width
*/
AnimatedImageView& SetMinimumWidth(float width) { View::SetMinimumWidth(width); return *this; }
/**
* @brief Sets the minimum height.
*
* @param[in] height The minimum height
*/
AnimatedImageView& SetMinimumHeight(float height) { View::SetMinimumHeight(height); return *this; }
/**
* @brief Sets the maximum width.
*
* @param[in] width The maximum width
*/
AnimatedImageView& SetMaximumWidth(float width) { View::SetMaximumWidth(width); return *this; }
/**
* @brief Sets the maximum height.
*
* @param[in] height The maximum height
*/
AnimatedImageView& SetMaximumHeight(float height) { View::SetMaximumHeight(height); return *this; }
/**
* @brief Sets the view margin.
*
* @param[in] margin The margin to set
*/
AnimatedImageView& SetViewMargin(const Extents& margin) { View::SetViewMargin(margin); return *this; }
/**
* @brief Sets the view padding.
*
* @param[in] padding The padding to set
*/
AnimatedImageView& SetViewPadding(const Extents& padding) { View::SetViewPadding(padding); return *this; }
/**
* @brief Sets whether the actor should be focusable by keyboard navigation.
*
* @param[in] focusable True if it is focusable
*/
AnimatedImageView& SetFocusable(bool focusable) { View::SetFocusable(focusable); return *this; }
/**
* @brief Sets whether the actor should be focused when touched.
*
* @param[in] touchFocusable True if it gets focused when touched
*/
AnimatedImageView& SetTouchFocusable(bool touchFocusable) { View::SetTouchFocusable(touchFocusable); return *this; }
/**
...
*/
AnimatedImageView& SetBackgroundColor(const UiColor& color) { View::SetBackgroundColor(color); return *this; }
/**
...
*/
AnimatedImageView& SetEnabled(bool enabled) { View::SetEnabled(enabled); return *this; }
/**
* @brief Sets a uniform corner radius for all four corners.
*
* @param[in] radius The corner radius to apply to all corners
*/
AnimatedImageView& SetCornerRadius(float radius) { View::SetCornerRadius(radius); return *this; }
/**
...
*/
AnimatedImageView& SetCornerRadius(float topLeft, float topRight, float bottomRight, float bottomLeft) { View::SetCornerRadius(topLeft, topRight, bottomRight, bottomLeft); return *this; }
/**
...
*/
AnimatedImageView& SetCornerRadius(const Vector4& radius) { View::SetCornerRadius(radius); return *this; }
/**
...
*/
AnimatedImageView& SetCornerRadiusPolicy(CornerRadiusPolicy policy) { View::SetCornerRadiusPolicy(policy); return *this; }
/**
...
*/
AnimatedImageView& SetCornerRadiusPolicyRelative() { View::SetCornerRadiusPolicyRelative(); return *this; }
/**
...
*/
AnimatedImageView& SetCornerSquareness(float squareness) { View::SetCornerSquareness(squareness); return *this; }
/**
...
*/
AnimatedImageView& SetCornerSquareness(float topLeft, float topRight, float bottomRight, float bottomLeft) { View::SetCornerSquareness(topLeft, topRight, bottomRight, bottomLeft); return *this; }
/**
...
*/
AnimatedImageView& SetCornerSquareness(const Vector4& squareness) { View::SetCornerSquareness(squareness); return *this; }
/**
* @brief Sets the borderline width of the view.
*
* @param[in] width The borderline width to set
*/
AnimatedImageView& SetBorderlineWidth(float width) { View::SetBorderlineWidth(width); return *this; }
/**
...
* @param[in] color The UiColor to apply
*/
AnimatedImageView& SetBorderlineColor(const UiColor& color) { View::SetBorderlineColor(color); return *this; }
/**
* @brief Sets the borderline offset of the view.
*
* @param[in] offset The borderline offset to set
*/
AnimatedImageView& SetBorderlineOffset(float offset) { View::SetBorderlineOffset(offset); return *this; }
/**
* @brief Sets the name of this view.
*
* @param[in] name The name to set
*/
AnimatedImageView& SetName(const Dali::String& name) { View::SetName(name); return *this; }
/**
* @brief Attaches the interaction trait to this View.
*
* @return Reference to this View for fluent chaining
*/
AnimatedImageView& AsInteractive() { View::AsInteractive(); return *this; }
/**
...
*/
template<typename F>
AnimatedImageView& AsInteractive(F&& configure) { View::AsInteractive(configure); return *this; }
/**
...
* @return Reference to this View for fluent chaining
*/
AnimatedImageView& AsSelectable() { View::AsSelectable(); return *this; }
/**
...
*/
template<typename F>
AnimatedImageView& AsSelectable(F&& configure) { View::AsSelectable(configure); return *this; }
/**
...
*/
AnimatedImageView& As(View& self) { View::As(self); return *this; }
/**
...
*/
template<typename F>
AnimatedImageView& With(F&& action)
{
  action(*this);
  return *this;
}
...
* @endcode
*/
AnimatedImageView& SetLayoutParams(LayoutParams params) { View::SetLayoutParams(params); return *this; }
/**
...
*/
AnimatedImageView& Children(std::initializer_list<View> children) { View::Children(children); return *this; }
