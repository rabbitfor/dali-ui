...
*/
ScrollView& SetScaleX(float scaleX) { View::SetScaleX(scaleX); return *this; }
/**
* @brief Sets the y scale factor applied to the view.
*
* @param[in] scaleY The Y scale factor to set
*/
ScrollView& SetScaleY(float scaleY) { View::SetScaleY(scaleY); return *this; }
/**
* @brief Sets the y scale factor applied to the view.
*
* @param[in] scaleX The X scale factor to set
* @param[in] scaleY The Y scale factor to set
*/
ScrollView& SetScale(float scaleX, float scaleY) { View::SetScale(scaleX, scaleY); return *this; }
/**
...
*/
ScrollView& SetVisibility(bool visibility) { View::SetVisibility(visibility); return *this; }
/**
...
* @return Reference to this View for fluent chaining
*/
ScrollView& SetOpacity(float opacity) { View::SetOpacity(opacity); return *this; }
/**
* @brief Sets the X position of the View.
*
* @param[in] x The X position to set
*/
ScrollView& SetPositionX(float x) { View::SetPositionX(x); return *this; }
/**
* @brief Sets the Y position of the View.
*
* @param[in] y The Y position to set
*/
ScrollView& SetPositionY(float y) { View::SetPositionY(y); return *this; }
/**
* @brief Sets the parent origin of the View.
*
* @param[in] point The parent origin to set
*/
ScrollView& SetParentOrigin(const Vector3& point) { View::SetParentOrigin(point); return *this; }
/**
* @brief Sets the pivot point of the View.
*
* @param[in] point The pivot point to set
*/
ScrollView& SetPivotPoint(const Vector3& point) { View::SetPivotPoint(point); return *this; }
/**
...
*/
ScrollView& SetRequestedWidth(float width) { View::SetRequestedWidth(width); return *this; }
/**
...
*/
ScrollView& SetRequestedHeight(float height) { View::SetRequestedHeight(height); return *this; }
/**
* @brief Sets the minimum width.
*
* @param[in] width The minimum width
*/
ScrollView& SetMinimumWidth(float width) { View::SetMinimumWidth(width); return *this; }
/**
* @brief Sets the minimum height.
*
* @param[in] height The minimum height
*/
ScrollView& SetMinimumHeight(float height) { View::SetMinimumHeight(height); return *this; }
/**
* @brief Sets the maximum width.
*
* @param[in] width The maximum width
*/
ScrollView& SetMaximumWidth(float width) { View::SetMaximumWidth(width); return *this; }
/**
* @brief Sets the maximum height.
*
* @param[in] height The maximum height
*/
ScrollView& SetMaximumHeight(float height) { View::SetMaximumHeight(height); return *this; }
/**
* @brief Sets the view margin.
*
* @param[in] margin The margin to set
*/
ScrollView& SetViewMargin(const Extents& margin) { View::SetViewMargin(margin); return *this; }
/**
* @brief Sets the view padding.
*
* @param[in] padding The padding to set
*/
ScrollView& SetViewPadding(const Extents& padding) { View::SetViewPadding(padding); return *this; }
/**
* @brief Sets whether the actor should be focusable by keyboard navigation.
*
* @param[in] focusable True if it is focusable
*/
ScrollView& SetFocusable(bool focusable) { View::SetFocusable(focusable); return *this; }
/**
* @brief Sets whether the actor should be focused when touched.
*
* @param[in] touchFocusable True if it gets focused when touched
*/
ScrollView& SetTouchFocusable(bool touchFocusable) { View::SetTouchFocusable(touchFocusable); return *this; }
/**
...
*/
ScrollView& SetBackgroundColor(const UiColor& color) { View::SetBackgroundColor(color); return *this; }
/**
...
*/
ScrollView& SetEnabled(bool enabled) { View::SetEnabled(enabled); return *this; }
/**
* @brief Sets a uniform corner radius for all four corners.
*
* @param[in] radius The corner radius to apply to all corners
*/
ScrollView& SetCornerRadius(float radius) { View::SetCornerRadius(radius); return *this; }
/**
...
*/
ScrollView& SetCornerRadius(float topLeft, float topRight, float bottomRight, float bottomLeft) { View::SetCornerRadius(topLeft, topRight, bottomRight, bottomLeft); return *this; }
/**
...
*/
ScrollView& SetCornerRadius(const Vector4& radius) { View::SetCornerRadius(radius); return *this; }
/**
...
*/
ScrollView& SetCornerRadiusPolicy(CornerRadiusPolicy policy) { View::SetCornerRadiusPolicy(policy); return *this; }
/**
...
*/
ScrollView& SetCornerRadiusPolicyRelative() { View::SetCornerRadiusPolicyRelative(); return *this; }
/**
...
*/
ScrollView& SetCornerSquareness(float squareness) { View::SetCornerSquareness(squareness); return *this; }
/**
...
*/
ScrollView& SetCornerSquareness(float topLeft, float topRight, float bottomRight, float bottomLeft) { View::SetCornerSquareness(topLeft, topRight, bottomRight, bottomLeft); return *this; }
/**
...
*/
ScrollView& SetCornerSquareness(const Vector4& squareness) { View::SetCornerSquareness(squareness); return *this; }
/**
* @brief Sets the borderline width of the view.
*
* @param[in] width The borderline width to set
*/
ScrollView& SetBorderlineWidth(float width) { View::SetBorderlineWidth(width); return *this; }
/**
...
* @param[in] color The UiColor to apply
*/
ScrollView& SetBorderlineColor(const UiColor& color) { View::SetBorderlineColor(color); return *this; }
/**
* @brief Sets the borderline offset of the view.
*
* @param[in] offset The borderline offset to set
*/
ScrollView& SetBorderlineOffset(float offset) { View::SetBorderlineOffset(offset); return *this; }
/**
* @brief Sets the name of this view.
*
* @param[in] name The name to set
*/
ScrollView& SetName(const Dali::String& name) { View::SetName(name); return *this; }
/**
* @brief Attaches the interaction trait to this View.
*
* @return Reference to this View for fluent chaining
*/
ScrollView& AsInteractive() { View::AsInteractive(); return *this; }
/**
...
*/
template<typename F>
ScrollView& AsInteractive(F&& configure) { View::AsInteractive(configure); return *this; }
/**
...
* @return Reference to this View for fluent chaining
*/
ScrollView& AsSelectable() { View::AsSelectable(); return *this; }
/**
...
*/
template<typename F>
ScrollView& AsSelectable(F&& configure) { View::AsSelectable(configure); return *this; }
/**
...
*/
ScrollView& As(View& self) { View::As(self); return *this; }
/**
...
* @endcode
*/
ScrollView& SetLayoutParams(LayoutParams params) { View::SetLayoutParams(params); return *this; }
/**
...
*/
ScrollView& Children(std::initializer_list<View> children) { View::Children(children); return *this; }
