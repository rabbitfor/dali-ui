 ...
 * toggles selection on click by listening to the owner View's ClickableTrait.
 * Unlike ClickableTraitImpl, this does not implement IInteractionTrait and
...
private:
  ...
  bool OnClickedForToggle(View view, const InputEvent& event);

private:
  WeakHandle<View>         mOwner;
  Signal<void(View, bool)> mSelectionChangedSignal;
  bool                     mSelected : 1;
