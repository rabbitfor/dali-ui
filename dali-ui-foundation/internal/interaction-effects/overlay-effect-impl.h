...
private:
  void AttachToInteractiveView(View view);
...
public:
  ...
  void        SuppressDefaultFocusIndicator(View owner);
  void        RestoreDefaultFocusIndicator();
...
private:
  ...
  View               mActiveTarget;
  View               mDefaultFocusIndicatorOwner;
  bool               mPressed;
  bool               mFocused;
  bool               mDefaultFocusIndicatorEnabledBeforeAttach;
  bool               mDefaultFocusIndicatorSuppressed;
};
