...
/**
 * @brief Verifies directional focus navigation (arrow keys) and Tab cycling.
 *
 ...
 *
 * Use arrow keys to move in 4 directions, and Tab to cycle forward.
 */
...
public:
  ...
  {
    return "Verifies directional (arrow keys) and Tab focus navigation";
  }

  void OnEnter(View contentArea) override
  {
    mStatusLabel = Label::New()
      .SetText("Press Tab or arrow keys to move focus")
