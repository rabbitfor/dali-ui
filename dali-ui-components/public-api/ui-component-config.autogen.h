...
// --- Chaining methods from UiConfig ---
/**
...
*/
UiComponentConfig& SetScalingFactor(float scalingFactor) { UiConfig::SetScalingFactor(scalingFactor); return *this; }
/**
...
*/
UiComponentConfig& SetDpi(int dpi) { UiConfig::SetDpi(dpi); return *this; }
/**
...
*/
UiComponentConfig& SetBaselineDpi(int baselineDpi) { UiConfig::SetBaselineDpi(baselineDpi); return *this; }
/**
...
*/
UiComponentConfig& SetKeyClickPolicy(KeyClickPolicy policy) { UiConfig::SetKeyClickPolicy(policy); return *this; }
/**
...
* @endcode
*/
UiComponentConfig& SetExecutionKeyPredicate(ExecutionKeyPredicate predicate) { UiConfig::SetExecutionKeyPredicate(predicate); return *this; }
/**
...
*/
UiComponentConfig& SetMinLongPressKeyCount(uint32_t count) { UiConfig::SetMinLongPressKeyCount(count); return *this; }
/**
...
*/
UiComponentConfig& SetTapRecognizerTime(uint32_t timeMs) { UiConfig::SetTapRecognizerTime(timeMs); return *this; }
/**
...
*/
UiComponentConfig& SetBrokenImageUrl(BrokenImageType brokenImageType, const Dali::String& brokenImageUrl) { UiConfig::SetBrokenImageUrl(brokenImageType, brokenImageUrl); return *this; }
/**
...
*/
UiComponentConfig& EnableFocusClearOnEscape(bool enable) { UiConfig::EnableFocusClearOnEscape(enable); return *this; }
/**
...
* @return Reference to this for method chaining
*/
UiComponentConfig& SetAlwaysShowFocus(bool alwaysShow) { UiConfig::SetAlwaysShowFocus(alwaysShow); return *this; }
/**
...
*/
UiComponentConfig& SetDefaultFontSize(float fontSize) { UiConfig::SetDefaultFontSize(fontSize); return *this; }
/**
...
*/
UiComponentConfig& SetDefaultTextColor(const Vector4& color) { UiConfig::SetDefaultTextColor(color); return *this; }
/**
...
* @return Reference to this for method chaining
*/
UiComponentConfig& SetDefaultInteractionEffect(Trait effect) { UiConfig::SetDefaultInteractionEffect(effect); return *this; }
