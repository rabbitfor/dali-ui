...
// DALi public classes are lightweight handles over internal implementations.
...
public:
  ...
  static MyButton New(const Dali::String& text)
  {
    ...
    button.SetAttachment(GetDataId(), Dali::MakeUnique<Data>(label, UiColor(0x1565C0), UiColor(0x2E7D32)))
